-- Applications with basic professional profile for request owners or the professional.
-- SECURITY: security definer to bypass profiles RLS, with explicit auth.uid() checks.
