-- Handi — Esquema V1 (DDL + RLS + Índices)
-- Extensiones
...
-- ===========================
-- PROFESSIONALS (perfil público profesional)
-- ===========================
...
-- PROFESSIONALS
drop policy if exists "professionals.select.public" on public.professionals;
...
-- Índices
-- ===========================
-- Profiles now only keeps user-basic fields; no last_active/rating indexes
...
-- Full-text search index for conditions (chips list stored as text)
...
-- ===========================
-- Cron de inactividad (referencia)
-- ===========================
-- UPDATE public.profiles SET active=false WHERE last_active_at < now() - interval '21 days';
