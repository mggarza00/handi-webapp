-- Canonical view for Receipt PDF data
-- Adjust join targets as your schema evolves; the view shape remains stable.
...
select
  ...
  -- Cliente (email puede no estar disponible en profiles)
