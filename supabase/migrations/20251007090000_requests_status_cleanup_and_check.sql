...
-- Normaliza cualquier valor legacy o fuera de catálogo (idempotente)
...
-- Elimina cualquier CHECK previo sobre status, tenga el nombre que tenga
...
-- Crea el CHECK final; si ya existe, ignora el error
do $$
begin
  begin
