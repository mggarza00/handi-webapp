-- Conversations + extended messages for contextual chat
begin;
...
-- Extend existing messages table to support conversation linkage
...
-- Additional conversation-based policies for messages (keeps existing policies intact)
