    ...
    <main className="mx-auto max-w-6xl px-4 py-10">
      ...
      <div className="grid gap-6 lg:grid-cols-12">
        ...
        <aside className="hidden lg:block lg:col-span-4">
          <nav aria-label="Índice" className="sticky top-24 rounded-lg border bg-white p-4 shadow-sm">
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li><a className="hover:underline" href="#factura-handi">3) Factura de la comisión de Handi</a></li>
        ...
        <section className="prose prose-slate max-w-none dark:prose-invert lg:col-span-8">
          ...
          <h2 id="factura-handi" className="scroll-mt-24 text-xl font-semibold">3) Factura de la comisión de Handi</h2>
          <ul className="list-disc pl-5">
          ...
          <p>
            Soporte Handi: <a className="underline" href="mailto:soporte@handi.com">soporte@handi.com</a> (ejemplo)
          </p>
