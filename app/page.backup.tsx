...
/** SEO para App Router (Next 13/14+) */
// app/layout.tsx (server component)
  ...
  twitter: {
    ...
    title: "Handee â€” Encuentra, conecta, resuelve.",
    description: "Perfiles verificados, reseÃ±as reales y respuesta rÃ¡pida.",
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <header className="sticky top-0 z-30 w-full border-b border-slate-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
          ...
          <nav className="hidden items-center gap-6 md:flex">
            <a href="#como-funciona" className="text-sm text-slate-600 hover:text-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300 rounded">
              CÃ³mo funciona
            </a>
            <a href="#categorias" className="text-sm text-slate-600 hover:text-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300 rounded">
              CategorÃ­as
            </a>
            <a href="#preguntas" className="text-sm text-slate-600 hover:text-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300 rounded">
              Preguntas
            </a>
          </nav>
          <div className="flex items-center gap-3">
            <Link
              href="/login"
              className="rounded-xl border border-slate-300 px-3 py-1.5 text-sm hover:bg-slate-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300"
            >
              Entrar
            </Link>
            <Link
              href="/postulate"
              className="hidden rounded-xl bg-slate-900 px-3 py-1.5 text-sm text-white hover:bg-black focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300 md:inline-block"
            >
        ...
        <div className="relative mx-auto grid max-w-5xl grid-cols-1 items-center gap-10 px-4 py-10 md:grid-cols-2 md:py-16">
          <div>
            ...
            <p className="mb-6 max-w-xl text-slate-600">
              Publica lo que necesitas o ofrece tus servicios. RÃ¡pido, seguro y con transparencia.
            </p>
            ...
            <p className="mt-3 text-xs text-slate-500">
              Â¿Ya tienes cuenta? Ve a tu perfil o revisa tus solicitudes en el menÃº.
            </p>
          </div>
      ...
      <section className="bg-slate-50" id="categorias">
        <div className="mx-auto max-w-5xl px-4 py-10">
          <h2 className="mb-2 text-xl font-semibold tracking-tight">Â¿QuÃ© necesitas hoy?</h2>
          <p className="mb-5 text-sm text-slate-600">
            Elige una categorÃ­a para empezar rÃ¡pido o explora todas.
          </p>
        ...
        <div className="mx-auto max-w-5xl px-4 py-12">
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
            <FeatureCard
              ...
              desc="Filtra por ciudad, categorÃ­a y disponibilidad."
            />
            <FeatureCard
              icon={<ShieldIcon className="h-5 w-5" />}
              title="Perfiles verificados"
              desc="Revisamos referencias, documentos y desempeÃ±o."
            />
            <FeatureCard
              icon={<StarIcon className="h-5 w-5" />}
              title="Calificaciones reales"
              desc="RetroalimentaciÃ³n de contratantes como tÃº."
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-slate-50">
        <div className="mx-auto max-w-5xl px-4 py-12">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <StepCard step="2" title="Recibe postulaciones" desc="Compara perfiles, reseÃ±as y cotizaciones." />
          ...
          <div className="flex flex-col items-center gap-4 md:flex-row md:justify-between">
            <div className="text-center md:text-left">
              ...
              <p className="text-sm text-slate-600">
                PolÃ­tica de bajas automÃ¡ticas ante calificaciones bajas recurrentes.
              </p>
            </div>
            <div className="flex items-center gap-3 text-xs text-slate-500">
              ...
              <span className="rounded-full border border-slate-200 px-3 py-1">Historial y reseÃ±as</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto max-w-5xl px-4 py-10">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm text-slate-600">
                <li>
                  <Link href="/search" className="hover:text-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300 rounded">
                    Buscar profesionales
                  </Link>
                </li>
                <li>
                  <Link href="/postulate" className="hover:text-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300 rounded">
                    Ofrecer mis servicios
                  </Link>
                </li>
                <li>
                  <Link href="/privacy" className="hover:text-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300 rounded">
                    Aviso de privacidad
                  </Link>
                </li>
              </ul>
              ...
              <ul className="space-y-1 text-sm text-slate-600">
                <li>
                  ...
                  <a
                    ...
                    className="hover:text-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300 rounded"
                    target="_blank"
          ...
          <div className="mt-8 border-t border-slate-200 pt-6 text-center text-xs text-slate-500">
            Â© {new Date().getFullYear()} Handee. Todos los derechos reservados.
          </div>
        </div>
      </footer>
    </main>
