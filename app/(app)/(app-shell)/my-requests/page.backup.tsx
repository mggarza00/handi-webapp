...
export default function MyRequests() {
  ...
  return (
    <div className="space-y-6">
      ...
      <input
        placeholder="Search"
        className="w-full rounded-xl border px-3 py-2 border-neutral-300 dark:border-neutral-800"
      />
      ...
      <div className="pt-2">
        <Link
          href="/requests/new"
          className="inline-flex h-10 items-center justify-center rounded-2xl px-4 border border-neutral-300 dark:border-neutral-800"
        >
