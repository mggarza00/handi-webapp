...
export default function Page() {
  ...
  <div className="absolute inset-0 z-0" style={{backgroundImage: 'url("/images/bg-categorias.jpg?v=12")', backgroundSize:"cover", backgroundPosition:"center", backgroundRepeat:"no-repeat"}}></div>
