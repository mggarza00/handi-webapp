...
const ItemSchema = z.object({
  ...
  amount: z
    .number({ required_error: "Monto requerido" })
...
export default function QuoteComposerDialog({
  open,
  onOpenChange,
  conversationId,
  onSubmitted,
  ...
  dialogDescription = "Genera una cotización para tu cliente",
}: Props) {
  ...
  const watchItems = useWatch({ control: form.control, name: "items" }) as
    ...
    try {
      ...
      if (onSubmitProp) {
        ...
        createdQuoteId =
          ...
          (json?.quote?.id as string | undefined) ??
          null;
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <FormControl>
                <Textarea
                  id="details"
                  placeholder="Ej. Vigencia, alcances y condiciones"
                  rows={3}
            ...
            <DialogFooter className="gap-2 flex-col sm:flex-row">
              <span className="text-xs text-muted-foreground sm:mr-auto">
                Precio no incluye IVA ni comision.
              </span>
