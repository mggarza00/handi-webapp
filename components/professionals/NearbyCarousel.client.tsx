    ...
    <div className="mt-12 rounded-xl mx-[calc(50%-50vw)] w-screen px-[var(--site-gutter)] py-4 md:py-6">
      ...
      <div className="mt-4 flex justify-center z-0 relative overflow-visible">
        {!showSecondRow && visibleCount < Math.min(items.length, 12) ? (
          ...
          <Link
            href="/professionals"
            className="relative isolate inline-flex h-9 items-center justify-center rounded-full px-4 text-sm font-medium text-slate-700 bg-[rgba(255,255,255,0.14)] backdrop-blur-2xl backdrop-saturate-150 ring-1 ring-white/25 shadow-[0_20px_60px_-10px_rgba(0,0,0,0.45)] before:content-[''] before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-b before:from-[rgba(255,255,255,0.6)] before:pointer-events-none z-20"
          >
            Ver todos
          </Link>
        )}
