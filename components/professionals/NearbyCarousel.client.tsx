...
export default function NearbyCarousel() {
  ...
  React.useEffect(() => {
    function compute() {
      ...
      const cardW = 220; // coincide con grid-auto-columns y min/max de la tarjeta
